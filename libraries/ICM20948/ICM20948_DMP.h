...
#define DMP_NO_ERR               0x00   // no error
#define DMP_ERR_NO_HEADER        0x01   // no header is available
...
#define ICM20948_SENSOR_ACCELEROMETER_UNCALIBRATED      DMP_Data_Output_Control_1_Accel|DMP_Data_Output_Control_1_Header2 // (16-bit gyro) + header2
#define ICM20948_SENSOR_GYROSCOPE_UNCALIBRATED          DMP_Data_Output_Control_1_Gyro|DMP_Data_Output_Control_1_Header2 // (16-bit gyro) + header2
#define ICM20948_SENSOR_MAGNETIC_FIELD_UNCALIBRATED     DMP_Data_Output_Control_1_Compass(|DMP_Data_Output_Control_1_Header2 //16-bit compass) + header2
  
#define ICM20948_SENSOR_ACCELEROMETER                   DMP_Data_Output_Control_1_Accel|DMP_Data_Output_Control_1_Header2 //(16-bit accel) + header2
//#define ICM20948_SENSOR_GYROSCOPE                       DMP_Data_Output_Control_1_Gyro|DMP_Data_Output_Control_1_Gyro_Calibr|DMP_Data_Output_Control_1_Header2 //(16-bit gyro + 32-bit calibrated gyro)
//DMP_Data_Output_Control_1_Gyro_Calibr not implemented in ICM20948
#define ICM20948_SENSOR_COMPASS                         DMP_Data_Output_Control_1_Compass|DMP_Data_Output_Control_1_Compass_Calibr|DMP_Data_Output_Control_1_Header2 //(16-bit compass+ 32-bit calibrated compass) + header 2


#define ICM20948_SENSOR_GAME_ROTATION_VECTOR           DMP_Data_Output_Control_1_Quat6|DMP_Data_Output_Control_1_Header2 //(32-bit 6-axis quaternion) + header2
#define ICM20948_SENSOR_ORIENTATION                    DMP_Data_Output_Control_1_Quat9|DMP_Data_Output_Control_1_Header2 //(32-bit 9-axis quaternion + heading accuracy) + header2
#define ICM20948_SENSOR_GEOMAGNETIC_ROTATION_VECTOR    DMP_Data_Output_Control_1_Geomag|DMP_Data_Output_Control_1_Header2 // 32-bit Geomag RV + heading accuracy) + header2
#define ICM20948_SENSOR_LINEAR_ACCELERATION            DMP_Data_Output_Control_1_Accel|DMP_Data_Output_Control_1_Quat6|DMP_Data_Output_Control_1_Header2 //(16-bit accel + 32-bit 6-axis quaternion) + header2
#define ICM20948_SENSOR_COMPASS_CALIBR                 DMP_Data_Output_Control_1_Compass_Calibr|DMP_Data_Output_Control_1_Header2
 // Bank 3 Types
...
#define INV_NEEDS_COMPASS_MASK1 ((1L << 2) | (1L << 7)) // I.e. 34 and 39
  ...
  enum DMP_Data_Output_Control_1_Register_Bits
  {
    ...
    DMP_Data_Output_Control_1_Geomag = 0x0100,         // 32-bit Geomagnetic rotation vector + heading accuracy
