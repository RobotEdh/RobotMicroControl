...
void DHT22Class::DHT22_init(uint8_t pin)
{
...
//
DHT22_ERROR_t DHT22Class::readData()
{
...
// to cache the result.
short int DHT22Class::getHumidityInt()
{
...
short int DHT22Class::getTemperatureCInt()
{
  return _lastTemperature;
}

// Return the percentage relative humidity in decimal form
double DHT22Class::getHumidity()
{
  return double(_lastHumidity)/10.0;
}
...
// Converts from the internal integer format on demand, so you might want
// to cache the result.
double DHT22Class::getTemperatureC()
{
  return double(_lastTemperature)/10.0;
}

double DHT22Class::getTemperatureF()
{
  return double(_lastTemperature) / 10.0 * 9.0 / 5.0 + 32.0;
}
